                ...
                <div class="item">
                    <div class="thumb">
                        <div class="hover-content">
                            <ul>
                                <li><a href="#" class="product-detail-link1" data-product-id="{{ $product->id }}"><i class="fa fa-eye"></i></a></li>
...
<script>
    ...
    $('.product-detail-link1').click(function(e){
        e.preventDefault();
        ...
        $.ajax({
            ...
            success: function(response){
                $('#product-detail-modal1 .modal-title').text('Chi tiết sản phẩm');
                $('#product-detail-modal1 .modal-body').html(
                    '<div class="row">' +
                        '<div class="col-md-8">' +
                ...
                $('#product-detail-modal1').modal('show');
            },
    ...
    $(document).on('click', '.add-to-cart-btn', function(e){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                // $('#product-detail-modal1').modal('hide')
            },
            error: function(xhr, status, error){
                console.error('Yêu cầu AJAX thất bại:', status, error);
            }
    ...
    <div class="modal fade" id="product-detail-modal1" tabindex="-1" role="dialog" aria-labelledby="productDetailModalLabel" aria-hidden="true">
